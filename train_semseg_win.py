...
Author: Benny
Date: Nov 2019
Windows-compatible version with NumPy 2.0 fixes
"""
import argparse
import os
...
def parse_args():
    ...
    parser.add_argument('--gpu', type=str, default='0,1,2,3,4,5,6,7', help='GPU to use [default: GPU 0]')
    ...
    parser.add_argument('--num_workers', type=int, default=24, help='Number of workers for data loading [default: 0 for Windows, should increase to 16 or 24 when running on VMs]')
