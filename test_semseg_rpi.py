...
def main(args):
    ...
    experiment_dir = 'log/sem_seg_rpi/' + args.log_dir
    ...
    TEST_DATASET_WHOLE_SCENE = DatasetWholeScene(root=root, block_size=1.0, block_points=NUM_POINT, stride=0.5, padding=0.001, num_classes=NUM_CLASSES)
