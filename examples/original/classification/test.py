"""
Original ModelNet classification evaluation entrypoint
Relocated under examples/original/classification.
"""
...
def main(args):
    ...
    '''CREATE DIR'''
    experiment_dir = REPO_ROOT.joinpath('log/classification', args.log_dir)
